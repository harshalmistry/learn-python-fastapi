...
async def get_all_items(skip: int = 0, limit: int = 2, city: str | None = None, age: int | None = None):
    employees = fake_employees_db[skip: skip + limit]
    if city:
        filtered_employees = filter(lambda seq: filter_employees_by_city(seq, city), employees)
...
async def create_employee(employee: Employee):
    ...
    fake_employees_db.append(employee_dict)
